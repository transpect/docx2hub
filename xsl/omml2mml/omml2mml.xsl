  ...
  <xsl:variable name="alpha-lowercase" select="'abcdefghijklmnopqrstuvwxyz'" as="xs:string"/>
	...
	<xsl:template match="m:borderBox" mode="omml2mml">
		...
		<xsl:variable name="sLowerCaseHideTop"
                    select="translate(m:borderBoxPr[last()]/m:hideTop[last()]/@m:val, $alpha-uppercase,                                                                 $alpha-lowercase)"/>
		    <xsl:variable name="sLowerCaseHideBot"
                    select="translate(m:borderBoxPr[last()]/m:hideBot[last()]/@m:val, $alpha-uppercase,                                                                 $alpha-lowercase)"/>
		    <xsl:variable name="sLowerCaseHideLeft"
                    select="translate(m:borderBoxPr[last()]/m:hideLeft[last()]/@m:val, $alpha-uppercase,                                                                 $alpha-lowercase)"/>
		    <xsl:variable name="sLowerCaseHideRight"
                    select="translate(m:borderBoxPr[last()]/m:hideRight[last()]/@m:val, $alpha-uppercase,                                                                 $alpha-lowercase)"/>
		    <xsl:variable name="sLowerCaseStrikeH"
                    select="translate(m:borderBoxPr[last()]/m:strikeH[last()]/@m:val, $alpha-uppercase,                                                                 $alpha-lowercase)"/>
		    <xsl:variable name="sLowerCaseStrikeV"
                    select="translate(m:borderBoxPr[last()]/m:strikeV[last()]/@m:val, $alpha-uppercase,                                                                 $alpha-lowercase)"/>
		    <xsl:variable name="sLowerCaseStrikeBLTR"
                    select="translate(m:borderBoxPr[last()]/m:strikeBLTR[last()]/@m:val, $alpha-uppercase,                                                                 $alpha-lowercase)"/>
		    <xsl:variable name="sLowerCaseStrikeTLBR"
                    select="translate(m:borderBoxPr[last()]/m:strikeTLBR[last()]/@m:val, $alpha-uppercase,                                                                 $alpha-lowercase)"/>
	  ...
	  <xsl:template name="CreateMathMLMatrixAttr">
		    ...
		    <xsl:variable name="sLowerCaseMcjc"
                    select="translate($mcJc, $alpha-uppercase,                                                                 $alpha-lowercase)"/>
		    <xsl:choose>
	...
	<xsl:template match="m:nary" mode="omml2mml">
		    <xsl:variable name="sLowerCaseSubHide">
			      <xsl:choose>
				        ...
				        <xsl:otherwise>
					          <xsl:value-of select="translate(m:naryPr[last()]/m:subHide/@m:val,                                     $alpha-uppercase,                                     $alpha-lowercase)"/>
				        </xsl:otherwise>
			      </xsl:choose>
		    </xsl:variable>
		    <xsl:variable name="sLowerCaseSupHide">
			      <xsl:choose>
				        ...
				        <xsl:otherwise>
					          <xsl:value-of select="translate(m:naryPr[last()]/m:supHide/@m:val,                                     $alpha-uppercase,                                     $alpha-lowercase)"/>
				        </xsl:otherwise>
			      </xsl:choose>
		    </xsl:variable>
		    <xsl:variable name="sLowerCaseLimLoc">
			      <xsl:value-of select="translate(m:naryPr[last()]/m:limLoc/@m:val,                                     $alpha-uppercase,                                     $alpha-lowercase)"/>
		    </xsl:variable>
	  ...
	  <xsl:template match="m:groupChr" mode="omml2mml">
		    ...
		    <xsl:variable name="sLowerCasePos"
                    select="translate($ndLastGroupChrPr/m:pos/@m:val,                                                         $alpha-uppercase,                                                         $alpha-lowercase)"/>

		    <xsl:variable name="sLowerCaseVertJc"
                    select="translate($ndLastGroupChrPr/m:vertJc/@m:val,                                                         $alpha-uppercase,                                                         $alpha-lowercase)"/>
	...
	<xsl:template name="CreateMathMLFracProp">
		    <xsl:param name="type"/>
		    <xsl:variable name="sLowerCaseType"
                    select="translate($type, $alpha-uppercase, $alpha-lowercase)"/>
	...
	<xsl:template match="m:e | m:den | m:num | m:lim | m:sup | m:sub" mode="omml2mml">
	  ...
	  <xsl:template match="m:bar" mode="omml2mml">
		    <xsl:variable name="sLowerCasePos"
                    select="translate(m:barPr/m:pos/@m:val, $alpha-uppercase,                                                                           $alpha-lowercase)"/>
