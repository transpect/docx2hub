...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="m:borderBox" mode="omml2mml">
    ...
    <xsl:variable name="sLowerCaseHideTop"    select="translate(m:borderBoxPr[last()]/m:hideTop[last()]/@m:val, $alpha-lowercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseHideBot"    select="translate(m:borderBoxPr[last()]/m:hideBot[last()]/@m:val, $alpha-lowercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseHideLeft"   select="translate(m:borderBoxPr[last()]/m:hideLeft[last()]/@m:val, $alpha-lowercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseHideRight"  select="translate(m:borderBoxPr[last()]/m:hideRight[last()]/@m:val, $alpha-lowercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseStrikeH"    select="translate(m:borderBoxPr[last()]/m:strikeH[last()]/@m:val, $alpha-lowercase,                       $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseStrikeV"    select="translate(m:borderBoxPr[last()]/m:strikeV[last()]/@m:val, $alpha-lowercase,                       $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseStrikeBLTR" select="translate(m:borderBoxPr[last()]/m:strikeBLTR[last()]/@m:val, $alpha-lowercase,                       $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseStrikeTLBR" select="translate(m:borderBoxPr[last()]/m:strikeTLBR[last()]/@m:val, $alpha-lowercase,                       $alpha-lowercase)"/>
  ...
  <xsl:template name="CreateMathMLMatrixAttr">
    ...
    <xsl:variable name="sLowerCaseMcjc"
      select="translate($mcJc, $alpha-lowercase, $alpha-lowercase)"/>
    <xsl:choose>
  ...
  <xsl:template match="m:phant" mode="omml2mml">
    <xsl:variable name="sLowerCaseZeroWidVal" select="translate(m:phantPr[last()]/m:zeroWid[last()]/@m:val, $alpha-lowercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseZeroAscVal" select="translate(m:phantPr[last()]/m:zeroAsc[last()]/@m:val, $alpha-lowercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseZeroDescVal" select="translate(m:phantPr[last()]/m:zeroDesc[last()]/@m:val, $alpha-lowercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseShowVal" select="translate(m:phantPr[last()]/m:show[last()]/@m:val, $alpha-lowercase, $alpha-lowercase)"/>
  ...
  <xsl:template match="m:rad" mode="omml2mml">
    <xsl:variable name="sLowerCaseDegHide"
      select="translate(m:radPr[last()]/m:degHide/@m:val, $alpha-lowercase, $alpha-lowercase)"/>
    <xsl:choose>
  ...
  <xsl:template match="m:nary" mode="omml2mml">
    <xsl:variable name="sLowerCaseSubHide">
      <xsl:choose>
        ...
        <xsl:otherwise>
          <xsl:value-of select="translate(m:naryPr[last()]/m:subHide/@m:val, $alpha-lowercase, $alpha-lowercase)"/>
        </xsl:otherwise>
      </xsl:choose>
    </xsl:variable>
    <xsl:variable name="sLowerCaseSupHide">
      <xsl:choose>
        ...
        <xsl:otherwise>
          <xsl:value-of select="translate(m:naryPr[last()]/m:supHide/@m:val, $alpha-lowercase, $alpha-lowercase)"/>
        </xsl:otherwise>
      </xsl:choose>
    </xsl:variable>
    <xsl:variable name="sLowerCaseLimLoc">
      <xsl:value-of
        select="translate(m:naryPr[last()]/m:limLoc/@m:val, $alpha-lowercase, $alpha-lowercase)"/>
    </xsl:variable>
  ...
  <xsl:template match="m:groupChr" mode="omml2mml">
    ...
    <xsl:variable name="sLowerCasePos"
      select="translate($ndLastGroupChrPr/m:pos/@m:val,               $alpha-lowercase,               $alpha-lowercase)"/>

    <xsl:variable name="sLowerCaseVertJc"
      select="translate($ndLastGroupChrPr/m:vertJc/@m:val,               $alpha-lowercase,               $alpha-lowercase)"/>
  ...
  <xsl:template match="m:f" mode="omml2mml">
    <xsl:variable name="sLowerCaseType"
      select="translate(m:fPr[last()]/m:type/@m:val, $alpha-lowercase, $alpha-lowercase)"/>
    <xsl:choose>
  ...
  <xsl:template name="CreateMathMLFracProp">
    <xsl:param name="type"/>
    <xsl:variable name="sLowerCaseType"
      select="translate($type, $alpha-lowercase, $alpha-lowercase)"/>
  ...
  <xsl:template match="m:bar" mode="omml2mml">
    <xsl:variable name="sLowerCasePos" select="translate(m:barPr/m:pos/@m:val, $alpha-lowercase, $alpha-lowercase)"/>
  ...
  <xsl:template match="m:r" mode="omml2mml">
    <xsl:variable name="sLowerCaseNor" select="translate(child::m:rPr[last()]/m:nor/@m:val, $alpha-lowercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseLit" select="translate(child::m:rPr[child::m:lit][last()]/@m:val, $alpha-lowercase, $alpha-lowercase)"/>
  ...
  <xsl:template name="CreateTokenAttributes">
    ...
    <xsl:variable name="sLowerCaseNor" select="translate($nor, $alpha-lowercase, $alpha-lowercase)"/>
    <xsl:choose>
    ...
    <mml:mtable>
      <xsl:for-each select="m:e">
        <mml:mtr>
          <mml:mtd>
            <xsl:choose>
              <xsl:when test="m:argPr[last()]/m:scrLvl/@m:val!='0' 
                              or not(m:argPr[last()]/m:scrLvl/@m:val) 
                              or m:argPr[last()]/m:scrLvl/@m:val=''">
                <mml:mrow>
                  <mml:maligngroup/>
              ...
              <xsl:when test="$context/ancestor::m:fName">
                <xsl:choose>
                  <xsl:when test="($iFirstOper=$iFirstNum) 
                                  and ($iFirstOper=string-length($sToParse)) 
                                  and (substring($sRepOperWith-, string-length($sRepOperWith-))!='0') 
                                  and (substring($sRepOperWith-, string-length($sRepOperWith-))!='-')">
